...
namespace Aim.WorkFlow
{
	...
	public partial class Task : EntityBase<Task>
	{
		...
		[Property("Title", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false, Length = 50)]
		public string Title
		{
			get { return _title; }
			set
		...
		[Property("Owner", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false, Length = 50)]
		public string Owner
		{
			get { return _owner; }
			set
		...
		[Property("Action", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false, Length = 50)]
		...
		[Property("WorkflowInstanceID", Access = PropertyAccess.NosetterCamelcaseUnderscore)]
		...
		[Property("ApprovalNodeName", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false, Length = 100)]
		...
		[Property("GroupID", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false)]
		...
		[Property("BookmarkName", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = false, Length = 50)]
