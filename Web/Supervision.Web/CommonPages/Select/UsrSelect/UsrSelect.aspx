<%@ Page Title="人员选择" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="UsrSelect.aspx.cs" Inherits="Aim.Portal.Web.CommonPages.UsrSelect" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            selCmdPanel = new Ext.ux.AimPanel({
                ...
                items: [{ xtype: 'button', text: '选择', handler: function () {
                    ...
                    AddSelections(document.getElementById('usrViewFrame').contentWindow.GetSelections());
                }
                ...
                items: [{ xtype: 'box', region: 'north', applyTo: 'header', height: 30 },
            {
                ...
                html: '<iframe width="100%" height="100%" id="usrCatalogFrame" name="frameContent" frameborder="0" src="UserCatalog.aspx"></iframe>'
            },
            {
                region: 'center',
                split: true,
        ...
        function SetCatalog(type, params) {
            catalogtype = type || params.type || 'default';
