...
{ fieldLabel: '编码', id: 'Code', schopts: { qryopts: "{ mode: 'Like', field: 'Code' }"}}]
                ...
                new Ext.app.AimSearchField({ store: store, hidden: true, schbutton: true, qryopts: "{ type: 'fulltext' }" }),
                '-',
                {
                    text: '复杂查询',
            ...
            { id: 'Func', header: '相关人员', width: 90, sortable: true, dataIndex: 'Func', renderer: linkRender },
            ...
            function linkRender(val, p, rec) {
                ...
                switch (this.dataIndex) {
                    case "Name":
                        ...
                        break;
                    case "Func":
                        rtn = "<a class='aim-ui-link' onclick='openUsers(\"" + rec.id + "\")' >编辑相关人员</a>";
                        break;
                }
