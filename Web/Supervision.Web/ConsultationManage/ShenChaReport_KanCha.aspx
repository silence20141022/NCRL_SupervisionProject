<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShenChaReport_KanCha.aspx.cs"
    Inherits="SP.Web.ConsultationManage.ShenChaReport_KanCha" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function print() {
            var ShenChaId = Ext.getCmp("Id").getValue();
            if (ShenChaId) {
                doprint("ShenChaReport_KanCha_Print.aspx?Id=" + ShenChaId);
            }
            else {
