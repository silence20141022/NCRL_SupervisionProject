...
<%@ Page Title="基坑支护" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master" AutoEventWireup="true" CodeBehind="ShenChaJKdy.aspx.cs" Inherits="SP.Web.ShenChaJKdy" %>
...
<table width="770" border="0"   cellspacing="0" cellpadding="0" style=" padding-bottom:300px; margin-top:30px;">
 ...
 <table width="770" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4"  height="70">&nbsp;1.是否按专家提出的设计方案审查意见进行施工图设计<br />
&nbsp;2.深基坑支护结构体系是否安全、可靠、无明显的不安全因素<br />
<br />
</td>
...
<table width="770" border="1" height="1050" cellspacing="0" cellpadding="0" >
  <tr>
    <td height="50" colspan="2" >&nbsp;1. 是否达到建设部《建筑工程设计文件编制深度的规定》和省有关规定要求<br />
&nbsp;2. 施工图是否按规定盖有出图章和签署<br />
  ...
  <tr>
  	 <td height="405"  valign="top"  id="sOpinion2" class="Opinion"></td>
  </tr>
  <tr>
    <td align="right" class="z" > 审查人员签章:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br />
...
&nbsp;2.是否损害公众利益<br />
  ...
  <tr>
  	 <td height="405"  valign="top"  id="sOpinion3" class="Opinion"></td>
  </tr>
  <tr>
    <td align="right" class="z" > 审查人员签章:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br />
...
<table width="770" border="1"  height="950" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="410"  valign="top"  id="sOpinion4" class="Opinion"></td>
  </tr>
   <tr>
    <td align="right" class="z" > 审查人员签章:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br />
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="410"  valign="top"  id="sOpinion5" class="Opinion"></td>
  </tr>
   <tr>
    <td align="right" class="z" > 审查人员签章:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br />
