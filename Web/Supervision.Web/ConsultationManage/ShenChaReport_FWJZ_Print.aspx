<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShenChaReport_FWJZ_Print.aspx.cs"
    Inherits="SP.Web.ConsultationManage.ShenChaReport_FWJZ_Print" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.post("ShenChaReport_FWJZ_Print.aspx", { action: "select", Id: Id }, function (data) {
                ...
                $("#BuildingArea").text(data.BuildingArea);
                $("#DetailLocation").text(data.DetailLocation);
                $("#EngineeringLevel").text(data.EngineeringLevel);
                $("#CengShu").text("地上" + data.UpperLayers + "层  地下" + data.DownLayers + "层");
                ...
                var date2 = data.Opinion2CreateTime;
                if (date2) {
                    var str = date2.split("/");
                    $("#Year2").text(str[0]);
                    $("#Month2").text(str[1]);
    ...
    <div>
        <table width="750px" border="0" height="1050" cellspacing="0" cellpadding="0" style="text-align: center">
            ...
            <tr style="margin-top: 120px; height: 155px">
                <td colspan="2" style="font-size: 20px; text-align: center; letter-spacing: 4px">
                    江 西 省 建 设 厅 制
                </td>
            </tr>
        </table>
        ...
        <div>
            ...
            <table class="table3" width="650px" style="margin-left: auto; margin-right: auto;
                border-collapse: collapse; border: none; font-size: 14px">
                <tr>
                    <td colspan="4" style="text-align: center; border-top: 0">
        ...
        <table class="table3" width="650px" style="margin-left: auto; margin-right: auto;
            ...
            <tr style="height: 50px">
                <td colspan="4" style="padding-left: 5px">
                    1.是否达到建设部《建筑工程设计文件编制深度的规定》和省有关规定要求；
                    <br />
                    2.施工图是否按规定盖有出图章和签署。
                </td>
            </tr>
