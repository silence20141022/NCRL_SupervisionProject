<%@ Page Title="标题" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="EngineeringQualityReportList.aspx.cs" Inherits="SP.Web.EngineeringQualityReportList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var EditWinStyle = CenterWin("width=720,height=160,scrollbars=yes");
        var EditPageUrl = "EngineeringQualityReportEdit.aspx";
        ...
        function setPgUI() {
            ...
            myData = {
                ...
                records: AimState["WorkSummaryList"] || []
            };

            // 表格数据源
            store = new Ext.ux.data.AimJsonStore({
                dsname: 'WorkSummaryList',
                idProperty: 'Id',
                data: myData,
                fields: [
		    { name: 'Id' },
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                tlBar = new Ext.ux.AimToolbar({
					...
					{ id: 'FileId', dataIndex: 'FileId', header: '单位工程质量评估报告', width: 130, sortable: true, renderer: linkRender },
                ...
                function showwin(val) {
                    ...
                    f = AimState["url"];
                    EditDocumentButton.EditDocument(f + "/Filelist/" + val + "_单位工程质量评估报告.doc");
