<%@ Page Title="监理简报" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SupervisionDCList.aspx.cs" Inherits="SP.Web.SupervisionDCList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var EditWinStyle = CenterWin("width=1000,height=600,scrollbars=yes");
        var EditPageUrl = "SupervisionDCEdit.aspx";
        ...
        function setPgUI() { 
            ...
            function showwin(val) {
                opencenterwin("SupervisionDCEdit.aspx?op=v&id=" + val);
            }
