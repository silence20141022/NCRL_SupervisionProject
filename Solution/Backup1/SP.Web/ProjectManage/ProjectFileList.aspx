<%@ Page Title="项目资料管理" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectFileList.aspx.cs" Inherits="SP.Web.ProjectFileList" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        var EditWinStyle = "dialogWidth:370px; dialogHeight:90px; scroll:yes; center:yes; status:no; resizable:yes;";
        var EditPageUrl = "ProjectFileListEdit.aspx";
...
//        { name: 'ParentID', type: 'string' },
                ...
                listeners: {
                    rowselect: function(g, ridx, e) {
                        ...
                        if (!frameContent.reloadPage) {
                            frameContent.location.href = "ProjectFileItem.aspx?type=group&id=" + rec.id + "&typname=" + rec.data.Name + "&op=" + pgOperation;
                        }
            ...
            grid = new Ext.ux.grid.AimEditorTreeGridPanel({
                ...
                maxSize: 250,
                columns: [
				{ id: 'Name', header: "资料类别", renderer: colRender, width: 110, sortable: true, dataIndex: 'Name' }
...
//                if (recs.data.IsDelete == "1") {
//                    alert("由枚举项同步而来的分类不可进行删除")
//                    return;
//                }
            ...
            function showEditSubWin(op, rec) {
                OpenModelWin("/CommonPages/Select/RolSelect/PRJ_RoleSelect.aspx?seltype=multi", { op: op, id: rec.id },
                        "dialogWidth:370px; dialogHeight:90px; scroll:yes; center:yes; status:no; resizable:yes;seltype:multi",
                        function() {
