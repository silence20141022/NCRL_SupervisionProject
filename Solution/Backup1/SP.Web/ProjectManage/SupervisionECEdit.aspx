<%@ Page Title="环境因素及控制清单" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="true" CodeBehind="SupervisionECEdit.aspx.cs" Inherits="SP.Web.SupervisionECEdit" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function IniCheckBoxGroup() {
            var itemarray = [];
            var dsarray = $("#EnvironmentFactorIds").val().split(',');
            $.each(AimState["DSEnts"], function() {
                ...
                itemarray.push({ boxLabel: p.FactorName, name: p.Id, checked: sel });
            })
        ...
        function IniGrid() {
            ...
            var store2 = new Ext.ux.data.AimJsonStore({
                ...
                idProperty: 'Id',
                data: myData2,
                fields: [{ name: 'Id' }, { name: 'FactorName' }, { name: 'ControlMethod'}]
            });
            ...
            var grid2 = new Ext.ux.grid.AimGridPanel({
                ...
                columns: [
                    ...
                    { id: 'FactorName', dataIndex: 'FactorName', header: '环境因素', width: 200 },
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                <tr style="display: none">
                    <td>
                        <input id="Id" name="Id" />
                        <input id="EnvironmentFactorIds" name="EnvironmentFactorIds" />
                    </td>
                </tr>
                <tr>
