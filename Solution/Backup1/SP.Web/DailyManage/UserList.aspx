<%@ Page Title="用户管理" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="UserList.aspx.cs" Inherits="SP.Web.UserList" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditPageUrl = "UserOrgStructureEdit.aspx";
                ...
                listeners: {
                    rowselect: function(g, ridx, e) {
                        ...
                        if (!frameContent.reloadPage) {
                            frameContent.location.href = "UserView.aspx?type=group&id=" + rec.id + "&typname=" + rec.data.Name + "&op=" + pgOperation;
                        }
