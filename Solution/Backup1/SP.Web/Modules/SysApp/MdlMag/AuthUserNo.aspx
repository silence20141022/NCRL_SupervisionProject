<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="AuthUserNo.aspx.cs" Inherits="Aim.PMP.Web.Modules.SysApp.MdlMag.AuthUserNo" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            usrGrid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                frameContent.location.href = "AuthTree.aspx?type=user&op=r&Deny=Y&id=" + r.data.UserID + "&Role="+Role;
            });
