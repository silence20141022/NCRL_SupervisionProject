...
namespace SP.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class ProjectAttendanceDetail
    {
        #region 成员变量
        ...
        {
			ProjectAttendanceDetail[] tents = ProjectAttendanceDetail.FindAll(Expression.In("Id", args));

			foreach (ProjectAttendanceDetail tent in tents)
			{
				tent.DoDelete();
			}
        }
