...
namespace SP.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class ZhongShenOpinion_Project
    {
        #region 成员变量
        ...
        {
			ZhongShenOpinion_Project[] tents = ZhongShenOpinion_Project.FindAll(Expression.In("Id", args));

			foreach (ZhongShenOpinion_Project tent in tents)
			{
				tent.DoDelete();
			}
        }
