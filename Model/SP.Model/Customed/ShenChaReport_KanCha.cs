...
namespace SP.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class ShenChaReport_KanCha
    {
        #region 成员变量
        ...
        {
			ShenChaReport_KanCha[] tents = ShenChaReport_KanCha.FindAll(Expression.In("Id", args));

			foreach (ShenChaReport_KanCha tent in tents)
			{
				tent.DoDelete();
			}
        }
